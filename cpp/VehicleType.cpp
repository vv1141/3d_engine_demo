...
void VehicleType::setup(
  ...
  this->hullRotationalInertiaTensor = glm::mat3(
    m * (hullLength * hullLength + hullHeight * hullHeight), 0.0f, 0.0f, 0.0f, m * (hullWidth * hullWidth + hullLength * hullLength), 0.0f, 0.0f, 0.0f, m * (hullWidth * hullWidth + hullHeight * hullHeight));
  ...
  this->tyreRotationalInertiaTensor = glm::mat3(
    xz, 0.0f, 0.0f, 0.0f, xz, 0.0f, 0.0f, 0.0f, y);
